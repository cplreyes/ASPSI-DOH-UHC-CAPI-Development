...
|---|---|---|
| **Committed (must-finish)** | E2-F1-010, E0-010, E0-032a, E0-020, E0-032, E3-F1-001 | ~12h + E0-032a unbounded |
| **Stretch** | E2-F3-010, E2-F4-010 | ~6h |

> Capacity: ~25h solo-dev week. Hard commits are ~12h leaving room for E0-032a if it arrives heavy, or pulling stretch Designer validations (E2-F3-010 / E2-F4-010) into the week.

## Daily Notes

### 2026-04-28 (Mon) — Sprint 003 kickoff
...
- [ ] **Sprint 003 retrospective** (4 questions) filled in `sprint-current.md` by EOD Fri 2026-05-02; sprint archived to `scrum/sprints/sprint-003.md`; `sprint-current.md` reset for Sprint 004.
