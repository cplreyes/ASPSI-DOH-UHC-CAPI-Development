...
- [ ] **E3-F2-PWA-R3-GUIDE** closed: Round 3 split tester guide drafted at `docs/F2-PWA-UAT-Round-3-HCW-Survey-Tester-Guide-2026-05-13.md` (verify + new-scenarios bundle). Modeled on Round 2 format. Reviewed before Round 3 announcement.
