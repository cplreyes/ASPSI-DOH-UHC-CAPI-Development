...
> [!note] Sprint Close Stamp
> Sprint 005 ran its full Mon–Fri cadence (standups 2026-05-11 → 2026-05-15); retrospective drafted 2026-05-15. Mechanical close (archive + `sprint-current.md` reset) was skipped over the weekend and completed 2026-05-18 at Sprint 006 Day-1 kickoff. Carry-outs to Sprint 006: **E3-F1-088** (tablet-test slice), **E3-F1-001** (F1 FMF Designer pass), **E6-PWA-007** (UAT Round 3 — #271 still OPEN, never opened to testers), **E4-APRT-035** (cross-env QA, carry-context), **E0-008** (auto-standup no-work branch — retro Q4 prescribed).
...
- [ ] **E3-F1-001** closed: F1 FMF Designer pass complete; `FacilityHeadSurvey.fmf` saved and reviewed. *(Carries from Sprint 004.)* — **CARRIES to Sprint 006.**
...
- [ ] **E6-PWA-007** closed: Round 3 opened Wed 2026-05-13 to Shan (RA) + Kidd (main RA) + Marriz (Data Manager — focus on Sync/Map Report + Data dashboard) via `#f2-pwa-uat` Slack announcement + GitHub guide URLs + admin credentials. Testers run Wed-Fri AM. Triage rolling. R3 close-out Fri PM (label `from-uat-round-3-2026-05` created; all R3 issues triaged; sprint board updated). — **CARRIES to Sprint 006 (#271 still OPEN, last touched 2026-05-12 — never opened to testers).**
- [x] **Sprint 005 retrospective** (4 questions) filled in `sprint-current.md` 2026-05-15; sprint archived to `scrum/sprints/sprint-005.md` 2026-05-18; `sprint-current.md` reset for Sprint 006 2026-05-18.
...
>
> *Drafted by Claude on 2026-05-15 from log/git/memory evidence — accepted by Carl 2026-05-18 at archival.*
