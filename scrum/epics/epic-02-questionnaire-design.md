...
- [x] **E2-F3-010** F3 Designer validation + sign-off `status::done` `priority::high` `estimate::2h` ✅ *(swept 2026-06-13 @ S009 close: Designer validation done (compile clean since 6/8, re-proven across 9 publishes); field sign-off rides UAT R4)*
...
- [x] **E2-F4-010** F4 Designer validation + sign-off `status::done` `priority::high` `estimate::4h` ✅ *(swept 2026-06-13 @ S009 close: Designer validation done (same gate); field sign-off rides UAT R4)*
