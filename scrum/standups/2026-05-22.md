...
# Daily Standup — 2026-05-22, Friday

**Project:** UHC Survey Year 2 — CAPI Development
**Sprint:** 006 — **Goal A — UHC CAPI Designer passes:** F1/F3/F4 FMF Designer passes (`E3-F1-001`, `E3-F3-001`, `E3-F4-001`). *(E3-F1-088 tablet-verify deferred to Sprint 007 — blocked behind `E4-CSWeb-005`, a S007 carry of the Goal D subset commit.)*
**Sprint Day:** 5 of 5
...
## Yesterday — since 2026-05-21

**deliverables/**
- `deliverables/F2/PWA/app/src/admin/Layout.test.tsx`
- `deliverables/F2/PWA/app/src/admin/Layout.tsx`
- `deliverables/F2/PWA/app/src/admin/apps/Files.test.tsx`
- `deliverables/F2/PWA/app/src/admin/apps/Files.tsx`
- `deliverables/F2/PWA/app/src/admin/me/ChangePasswordPage.test.tsx`
- `deliverables/F2/PWA/app/src/admin/me/ChangePasswordPage.tsx`
- `deliverables/F2/PWA/worker/src/admin/routes.ts`
- `deliverables/F2/PWA/worker/test/admin/routes.test.ts`
...
|---|----|------|--------|----------|----------|
| 1 | **E3-F1-001** | F1 FMF Section A layout in CSPro Designer — generator emits `FacilityHeadSurvey.generated.fmf`. epic-03 E3-F1-001 **reopened 2026-05-18** (prior `done` superseded by the 05-12 rebuild). *(Carry — gated only on Carl's Designer time.)* | todo | high | 4h |
| 2 | **E3-F3-001** | F3 FMF Designer pass — Patient instrument (18 records / 840 items). | todo | high | 4h |
| 3 | **E3-F4-001** | F4 FMF Designer pass — Household instrument (22 records / 623 items, roster-heavy). | todo | high | 4h |
| 4 | **E6-PWA-007** | [#271](https://github.com/cplreyes/ASPSI-DOH-UHC-CAPI-Development/issues/271) — R3 close-out. R3 ran last week outside #271 (process gap — same pattern as the S005 #266–268 discovery). Triage + fix the ~13+ R3 findings (#302–#314 HCW survey + #294/#296/#298), close #271 with a comment linking the `from-uat-round-3-2026-05` issues, reconcile the tracking gap. Re-verify is tester-paced. | todo | critical | 6h Carl-driven |
| 5 | **E4-CSWeb-001** | Provision VPS — host/OS/network/TLS; CSWeb web UI reachable over HTTPS. | todo | critical | 1d |
| 6 | **E4-CSWeb-002** | CSWeb install + admin account setup. | todo | critical | 4h |

## Blockers & Impediments

- **At risk:** **E3-F1-001** F1 FMF Section A layout in CSPro Designer — generator emits `FacilityHeadSurvey.generated.fmf`. epic-03 E3-F1-001 **reopened 2026-05-18** (prior `done` superseded by the 05-12 rebuild). *(Carry — gated only on Carl's Designer time.)* — still `todo` past sprint midpoint
- **At risk:** **E3-F3-001** F3 FMF Designer pass — Patient instrument (18 records / 840 items). — still `todo` past sprint midpoint
- **At risk:** **E3-F4-001** F4 FMF Designer pass — Household instrument (22 records / 623 items, roster-heavy). — still `todo` past sprint midpoint
- **At risk:** **E6-PWA-007** [#271](https://github.com/cplreyes/ASPSI-DOH-UHC-CAPI-Development/issues/271) — R3 close-out. R3 ran last week outside #271 (process gap — same pattern as the S005 #266–268 discovery). Triage + fix the ~13+ R3 findings (#302–#314 HCW survey + #294/#296/#298), close #271 with a comment linking the `from-uat-round-3-2026-05` issues, reconcile the tracking gap. Re-verify is tester-paced. — still `todo` past sprint midpoint
- **At risk:** **E4-CSWeb-001** Provision VPS — host/OS/network/TLS; CSWeb web UI reachable over HTTPS. — still `todo` past sprint midpoint
- **At risk:** **E4-CSWeb-002** CSWeb install + admin account setup. — still `todo` past sprint midpoint

---

## Notes

_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-05-22T09:18+08:00. Edit freely._
