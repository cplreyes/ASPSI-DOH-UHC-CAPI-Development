...
# Daily Standup — 2026-08-21, Friday
...
> [!warning] Sprint window exceeded — Day 33 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
> Product Backlog last updated 2026-07-20 — 32 days stale. Consider regroom.
...
## Yesterday — since 2026-08-20

**deliverables/** (56 files)
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-21T18:49+08:00. Edit freely._
