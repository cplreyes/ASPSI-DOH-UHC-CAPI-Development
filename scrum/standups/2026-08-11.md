...
# Daily Standup — 2026-08-11, Tuesday
...
> [!warning] Sprint window exceeded — Day 23 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
> Product Backlog last updated 2026-07-20 — 22 days stale. Consider regroom.
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-11T08:30+08:00. Edit freely._
