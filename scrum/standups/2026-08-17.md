...
# Daily Standup — 2026-08-17, Monday
...
> [!warning] Sprint window exceeded — Day 29 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
> Product Backlog last updated 2026-07-20 — 28 days stale. Consider regroom.
...
- `deliverables/CSPro/F3/translations/bis.json`
- `deliverables/CSPro/F3/translations/ceb.json`
- _…and 18 more_
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-17T08:30+08:00. Edit freely._
