...
> [!warning] Scrum-state drift — `log.md` is 7.3 days newer than `sprint-current.md` (log last touched 2026-07-16, sprint board 2026-07-08). Work has been logged that the board hasn't absorbed, so its `status::` fields are behind reality. **Sync `sprint-current.md`** — fold the logged outcomes into the board — before trusting today's Sprint Board / Today columns. _(E0-SCRUM-SYNC canary.)_
...
- `deliverables/CSPro/data/assignments/assignments-source.csv`
- `deliverables/CSPro/data/assignments/targets.json`
- `deliverables/CSPro/data/roster/roster-source.csv`
...
- `deliverables/CSPro/supervisor-hub/MenuApp.fmf`
- _…and 26 more_
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-07-16T08:30+08:00. Edit freely._
