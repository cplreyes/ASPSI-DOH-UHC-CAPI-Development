...
- `scrum/sprints/sprint-005.md`

**wiki/**
- `wiki/sources/Source - ASPSI Team Meeting 2026-05-18.md`
...
| 5 | **E0-008** | Auto-standup no-work-since-last-run branch in `.claude/scripts/generate_standup.py` — detect sprint roll-over + no-commits window, surface "silence ≠ idle". Retro Q4 prescribed (3rd deferral). | todo | high | 1.5h |
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-05-19T11:32+08:00. Edit freely._
