...
# Daily Standup — 2026-08-25, Tuesday
...
- `deliverables/CSPro/RELEASE-NOTES.md`
- `deliverables/CSPro/WHATS-NEW.md`
- `deliverables/CSPro/automation/release-notes-extra.json`
- `deliverables/CSPro/automation/triage-state.json`
- `deliverables/CSPro/versions.json`
- `deliverables/meetings/2026-08-24-aspsi-team-meeting.md`
...
|---|----|------|--------|----------|----------|
| 1 | **Close UAT Round 7 to zero actionable** | — #1311 (F1 Q35.2) + #1312 (F2 Q24.2) adopt DOH's final option lists, plus anything new. Ship as versioned DEV builds through the `capi-devops` gates, never as quiet edits. | todo | critical | — |
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-25T08:30+08:00. Edit freely._
