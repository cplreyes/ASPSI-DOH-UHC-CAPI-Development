...
# Daily Standup — 2026-07-25, Saturday
...
> [!warning] Sprint window exceeded — Day 6 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
## Yesterday — gap window 2026-07-23 → 2026-07-24 (2 days)
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-07-25T12:52+08:00. Edit freely._
