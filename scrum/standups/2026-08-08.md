...
# Daily Standup — 2026-08-08, Saturday
...
> [!warning] Sprint window exceeded — Day 20 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
> Product Backlog last updated 2026-07-20 — 19 days stale. Consider regroom.
...
## Yesterday — gap window 2026-08-06 → 2026-08-07 (2 days)
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-08T09:12+08:00. Edit freely._
