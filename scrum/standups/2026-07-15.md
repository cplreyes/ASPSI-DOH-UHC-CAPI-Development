...
# Daily Standup — 2026-07-15, Wednesday
...
> [!warning] Sprint window exceeded — Day 10 of 5. Sprint 013 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 013 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
## Yesterday — since 2026-07-14

**deliverables/** (87 files)
- `deliverables/CSPro/ASPSI-GO-NOGO-2026-06-27.md`
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-07-15T16:36+08:00. Edit freely._
