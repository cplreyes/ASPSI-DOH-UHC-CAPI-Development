...
# Daily Standup — 2026-08-09, Sunday
...
> [!warning] Sprint window exceeded — Day 21 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
> Product Backlog last updated 2026-07-20 — 20 days stale. Consider regroom.
...
## Yesterday — since 2026-08-08

**deliverables/** (18 files)
- `deliverables/CSPro/F1/FacilityHeadSurvey.ent.apc`
- `deliverables/CSPro/F1/messages-registry.json`
- `deliverables/CSPro/automation/auto_deploy.py`
- `deliverables/CSPro/automation/triage-state.json`
- `deliverables/CSPro/supervisor-hub/Assignment.dcf`
- `deliverables/CSPro/supervisor-hub/FacilityHeadSurvey.dcf`
- `deliverables/CSPro/supervisor-hub/HouseholdSurvey.dcf`
- `deliverables/CSPro/supervisor-hub/LoginApp.dcf`
- `deliverables/CSPro/supervisor-hub/LoginApp.ent.apc`
- `deliverables/CSPro/supervisor-hub/LoginApp.fmf`
- `deliverables/CSPro/supervisor-hub/MenuApp.dcf`
- `deliverables/CSPro/supervisor-hub/MenuApp.ent.apc`
- _…and 6 more_
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-09T08:30+08:00. Edit freely._
