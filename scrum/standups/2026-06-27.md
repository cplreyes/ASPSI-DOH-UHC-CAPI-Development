...
# Daily Standup — 2026-06-27, Saturday

**Project:** UHC Survey Year 2 — CAPI Development
**Sprint:** 011 — TBD
**Sprint Day:** 6 of 5

> [!warning] Sprint window exceeded — Day 6 of 5. Sprint 011 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 011 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-06-27T08:30+08:00. Edit freely._
