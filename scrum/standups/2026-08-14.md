...
> [!warning] Scrum-state drift — `log.md` is 23.8 days newer than `sprint-current.md` (log last touched 2026-08-13, sprint board 2026-07-20). Work has been logged that the board hasn't absorbed, so its `status::` fields are behind reality. **Sync `sprint-current.md`** — fold the logged outcomes into the board — before trusting today's Sprint Board / Today columns. _(E0-SCRUM-SYNC canary.)_
...
## Yesterday — gap window 2026-08-12 → 2026-08-13 (2 days)

**(root)/**
- `log.md`

**deliverables/** (61 files)
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-14T08:57+08:00. Edit freely._
