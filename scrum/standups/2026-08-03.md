...
# Daily Standup — 2026-08-03, Monday
...
> [!warning] Sprint window exceeded — Day 15 of 5. Sprint 014 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 014 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
## Yesterday — gap window 2026-07-31 → 2026-08-02 (3 days)
...
**deliverables/**
- `deliverables/training/2026-08-capi-sessions.md`

**wiki/**
- `wiki/analyses/Analysis - Pretest Findings vs the CAPI Build.md`
- `wiki/concepts/Field Training Program.md`
- `wiki/entities/Dr Paulyn Claro.md`
- `wiki/entities/PSA.md`
- `wiki/entities/SJREB.md`
- `wiki/sources/Source - DOH Deliverable No. 2 (2026-07-31).md`
- `wiki/sources/Source - PSA Survey Clearance 26SS02-481 (2026-07-23).md`
- `wiki/sources/Source - Pretest Report (2026-07-30).md`
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-08-03T09:35+08:00. Edit freely._
