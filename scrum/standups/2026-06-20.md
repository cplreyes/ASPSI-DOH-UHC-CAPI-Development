...
# Daily Standup — 2026-06-20, Saturday
...
> [!warning] Sprint window exceeded — Day 6 of 5. Sprint 010 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 010 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
**docs/**
- `docs/superpowers/plans/2026-06-19-capi-multiselect.md`
- `docs/superpowers/specs/2026-06-19-capi-multiselect-skill-design.md`
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-06-20T08:30+08:00. Edit freely._
