...
# Daily Standup — 2026-07-19, Sunday
...
> [!warning] Sprint window exceeded — Day 14 of 5. Sprint 013 ran past its end date without being closed and rolled over, so this auto-standup is **provisional** — it reflects a sprint that should already be retired. Run `/scrum` to close Sprint 013 (Mode D retro + archive) and plan the next one. _Silence ≠ idle: an unreset sprint does not mean no work happened._
...
_Auto-generated by `.claude/scripts/generate_standup.py` on 2026-07-19T08:30+08:00. Edit freely._
