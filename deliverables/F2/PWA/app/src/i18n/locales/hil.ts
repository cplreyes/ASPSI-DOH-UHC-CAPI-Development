// Hiligaynon bundle — app CHROME is English-fallback (DRAFT, pending ASPSI QC).
// The Hiligaynon SURVEY CONTENT (questions, choices, sections) is fully wired and
// lives in spec/translations/hil.json. App-furniture strings (buttons, sync,
...
export const hil: EnBundle = {
  ...
  consent: {
    ...
    // with the Aug-17 paper and no cleared hil translation exists yet.
    infoStudy:
