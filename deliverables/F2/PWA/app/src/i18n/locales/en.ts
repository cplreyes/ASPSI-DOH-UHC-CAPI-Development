...
export const en = {
  ...
  consent: {
    ...
    // #1313 (2026-08-25): Part I synced to the Aug-17 paper's substance —
    // "requests your participation", the ~1-hour duration, and the new
    // topics-covered sentence. Self-admin phrasing kept (registered
    // capi-adaptation: the paper is a read-aloud script; this is a screen).
    infoStudy:
    ...
    // aug17 migration (Task 3.1, 2026-08-19): synced to the Aug-17 printed
    // ethics-contact table (F2-paper.csv rows 49-57 / F2-inventory.md §1) —
    // the SJREB email/phone and ASPSI email here were stale (an older
    // contact set); the DOH/Villarante block was already correct.
    contactsBody:
