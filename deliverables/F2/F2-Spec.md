...
- SJREB informed consent (click-through gate) — implemented in the PWA as a per-case ConsentScreen (R6 #808, 2026-07-02): shown after enrollment and after every "Start new survey", before Section A; records consent_given=1 + consent_timestamp with the response; decline shows a thank-you and never opens the questionnaire
...
| Q2 | Q2 | single + specify | Y | What type of employment do you have at this health facility? | Regular · Casual · Seasonal · Probationary · Project-based · Fixed-term · Other, specify; help: "Definitions — 1. Regular Employment: Employees perform tasks necessary or desirable to the employer's main business, usually after a probationary period. They enjoy full security of tenure. 2. Probationary Employment: A trial period (maximum of 6 months) to determine if the employee meets the standards for regularization. 3. Casual Employment: Work is not essential to the main business and is usually for a short period. If a casual employee works for at least one year, they may become regular. 4. Project-based (Project Employment): Employment is fixed for a specific project or undertaking, with the end date determined by the completion of that project. 5. Seasonal Employment: Work is only performed during specific, recurring times of the year, such as holidays or harvest seasons. 6. Fixed-Term Employment: The contract specifies a set duration for the employment, agreed upon by both parties. 7. Other (Job Order): worker is classified as a contractual worker or contract of service personnel, hired for a short-term, specific piece of work." | — | — | OK — 7-item definition block added to help per R6 #810; "Project" renamed "Project-based" per R6 #811 |
...
| Q5 | Q5 | single + specify | Y | What is your role at this health facility? | Administrator · Physician/Doctor · Physician assistant · Nurse · Nursing assistant · Pharmacist/Dispenser or Assistant Pharmacist · Midwife · Laboratory technician · Medical/ radiologic technologist · Health promotion officer · Nutrition-Dietician or Nutrition Action Officer/Coordinator · Physical Therapist · Dentist · Dentist aide · Barangay Health Worker · Other (specify) | — | — | **SECTION** — Q5 drives gating for Sections C, D, E1, E2, G. Must branch to role-specific sections. R6 #820: "Pharmacist/Dispenser" and "Nutrition action officer/coordinator" renamed; the Nutrition-Dietician role now routes with Administrator/Nurse/Midwife (Sections C, D, E1, E2; not G). |
...
| Q32 | Q28 | multi | Y | Which of the following are included in the YAKAP/Konsulta package? | Pap smear · Mammogram · Lipid profile · Thyroid function test · Chest X-ray · Low-dose Chest CT scan · Dental services · All of the above · I don't know | — | OK · R6 #812: "All of the above" is standalone (mutually exclusive; auto-clears the individual options) — reverses R3 #17 auto-select |
...
| Q35 | Q31 | partial-date | conditional | Since when? | Year / Month / Day; help: "Year is required. Leave month or day blank if you don't recall them." | — | only if Q34 = Yes (PDF does not tag [Q35]; numbering is preserved). R3 #306: changed `date` → `partial-date` per Myra 2026-05-21 ("Year is important. Month and day can be optional."). Stored as one ISO-8601 variable-precision value (`YYYY` \| `YYYY-MM` \| `YYYY-MM-DD`); year required, month + day each independently optional. |
| Q36 | Q32 | multi + specify | conditional | Why is your facility applying to become an accredited YAKAP/Konsulta provider? | Predictable revenue due to capitation · YAKAP is more comprehensive · High volume of patients · Other (specify) | all answers → Q41 | only if Q34 = Yes; all answers jump to Q41 (skips Section C tail). R3 #307/5a: switched single→multi per Myra 2026-05-21. |
...
| Q39 | Q35 | multi + specify | conditional | Why would your facility consider it? | Predictable revenue due to capitation · YAKAP is more comprehensive · High volume of patients · Other, specify | — | only if Q38 = Yes. R3 #309: removed "Not a physician/dentist" option per Myra 2026-05-21 (structurally unreachable — Q39 only shown when Q38 = Yes, and selecting "Not a physician/dentist" at Q38 routes past Q39 entirely). |
...
| Q45 | Q41 | multi + specify | conditional | What are your sources of information about ZBB? | *[same choice set as Q42]* | — | only if Q44 = Yes |
| Q46 | Q42 | multi + specify | conditional | What is your understanding about the Zero Balance Billing (ZBB)? | *[same choice set as Q43]* | — | only if Q44 = Yes |
| Q47 | — | multi + specify | conditional | What challenges do you commonly encounter for patients covered by ZBB? | Lack/Insufficient medicines/supplies · Limited diagnostic services · High patient volume/workload · Documentation/compliance issues · ICT/system limitations · Patient-related concerns · Other (specify) · None | — | **NEW in Apr 20** (Annex G #7 — ZBB explicit coverage); only if Q44 = Yes. R3 #310: "None" added as standalone (auto-clears others) per Myra 2026-05-21. |
...
| Q52 | Q45 | multi + specify | conditional | In your opinion, BUCAS Centers have: | Improved access to care · Improved quality of care · Reduced patient congestion · No significant impact · Other (specify) | — | only if Q49 = Yes (reformatted from Apr 08 Q45). R3 #304: "No significant impact" is standalone (mutually exclusive with the positive-impact options; auto-clears them) per Myra 2026-05-21. |
...
| pdf_q | legacy_q | type | required | label (verbatim) | choices / notes | skip | gf_risk |
|---|---|---|---|---|---|---|---|
| Q56 | Q49 | multi + specify | Y | What is/are the most common way/s you send referrals to higher level facilities? | Physical referral slip · E-referral · Referring facility calls receiving facility · Not applicable · I don't know · Other (specify) | — | OK · R6 #815: NA/IDK added (roles not involved in referrals); both exclusive on this multi |
| Q57 | Q50 | single + specify | Y | What type of referral form do you use to send to higher level facilities? | DOH standard referral form · Facility's standard referral form · Province's standard referral form · City / LGU standard referral form · No standard referral form · Not applicable · I don't know · Other (specify) | — | OK · R6 #815: NA/IDK added |
...
| Q71a | Q63 | long-text | conditional | If yes, what are the implications? | —; help: "For those who answered 'Yes' in Q69 (ZBB)" | Q69 = Yes | — | OK — paper 71a; split per R6 #817 (reverses the fold) |
| Q71b | — | long-text | conditional | If yes, what are the implications? | —; help: "For those who answered 'Yes' in Q70 (NBB)" | Q70 = Yes | — | OK — paper 71b; split per R6 #817 |
...
| Q87 | Q78 | single | conditional | Have you experienced professional fee balance billing despite the insurance/ZBB? | Yes · No | only for respondents from DOH-retained hospitals | — | **SPLIT** · R6 #821: paper's "No → Q90" skip deliberately removed (UAT lead) — any answer proceeds to Q88 (NBB); Q88 = No drives the skip to Q90 |
...
| Q110 | Q99 | multi + specify | Y | What additional resources do you need to perform well in this job? | Professional development opportunities · Better compensation policies · Better equipment / facilities · Other (specify) · None | OK · R3 #311: "None" added as standalone (auto-clears others) per Myra 2026-05-21. |
...
2. **Q2 help text on employment types** — 7-item definition block needs shortening for Forms section help (max ~500 char renders cleanly on mobile). **RESOLVED per R6 #810 (2026-07-02):** full 7-item definition block added verbatim to Q2 help text in the PWA.
...
6. **Q71 "71a / 71b" conditional prompts** — consider collapsing into a single long-text and letting the respondent answer whichever policy (ZBB or NBB) they know about. **REVERSED per R6 #817 (2026-07-02):** Q71 split into Q71a (Q69=Yes) + Q71b (Q70=Yes) matching the printed sub-rows.
