...
---------------------------------------
The last part of FORM_PLAN's geographic entry: ('FIELD_CONTROL', {'names':
['BREAKOFF']}), so BREAKOFF is still the final field of the first interactive form
and still adds no form of its own.
========================================================================
#744 — inject the BREAKOFF "interview status" control into F1's hand-maintained
