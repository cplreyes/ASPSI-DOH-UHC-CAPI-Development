...
---------------------------------------
FORM_PLAN's order plus generate_fmf._assert_form_invariants(), which fails the build
unless Facility GPS is the LAST form and sits immediately after the photo.
========================================================================
Relocate F1's "Facility GPS" form to DEAD LAST — after the Case Verification
