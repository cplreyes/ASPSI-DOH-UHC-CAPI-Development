...
per-instrument release-notes + versioning monitor. Pass --notes "text" (keep it last
on the command line) to record a human bullet for the new version; otherwise the
entry carries the version-bump commit's subject once committed.
