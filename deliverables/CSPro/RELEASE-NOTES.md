...
|---|---|---|
| F1 - Facility Head Survey | **v3.1.5** | 2026-08-20 |
| F3 - Patient Survey | **v6.0.2** | 2026-08-20 |
| F4 - Household Survey | **v3.1.3** | 2026-08-20 |
| HUB - Supervisor Hub | **v1.1.5** | 2026-08-08 |
| F2 - Healthcare Worker Survey (PWA) | **v2.1.0** | see F2 CHANGELOG |

## Unreleased

- **F1 v3.1.5** (2026-08-20) - bumped in the working tree, not yet committed
- **F3 v6.0.2** (2026-08-20) - bumped in the working tree, not yet committed
- **F4 v3.1.3** (2026-08-20) - bumped in the working tree, not yet committed
