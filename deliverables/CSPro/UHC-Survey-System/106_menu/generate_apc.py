...
function view_menu()
   { Phase 1 SIMPLIFICATION: skip role check entirely. Phase 2 will           }
   { reintroduce role-conditional dispatch once savesetting/loadsetting       }
   { cross-pen persistence is debugged on Android.                            }
   cell_option = accept(
