...
<div class="app">
  <aside class="sidebar">
    ...
    <div class="sb-proj"><div class="sb-proj-card"><div class="k">Signed in as</div>
      <div class="v"><?= htmlspecialchars($user, ENT_QUOTES) ?></div><a href="/docs/auth/logout" style="display:inline-block;margin-top:7px;font-size:12px;font-weight:650;color:var(--verde);text-decoration:none">Sign out &rarr;</a></div></div>
    <nav class="sb-nav">
