      ...
      <div class="container">
        ...
        <article>
          ...
          <section>
            ...
            <ol>
              ...
              <li><strong>&#8942; &rarr; Add Application &rarr; CSWeb server</strong> &mdash;
                <code>https://csweb.asiansocial.org/csweb/api</code> &rarr; sign in with
                <strong>your own username and password</strong> &rarr; <strong>Connect</strong>.</li>
              <li>You will see <strong>five</strong> applications. <strong>Enumerators install these four:</strong>
                <strong>LoginApp</strong>, <strong>FacilityHeadSurvey</strong>, <strong>PatientSurvey</strong> and
                <strong>HouseholdSurvey</strong>. <em>Do not install SupervisorApp</em> &mdash; that one is for
                your STL only.</li>
              <li>Then <strong>check the version of each</strong>:</li>
            </ol>
            <table>
              ...
              <tbody>
                ...
                <tr><td>Supervisor &amp; Enumerator Hub (LoginApp)</td><td><strong>v1.1.2</strong></td></tr>
              </tbody>
            </table>
            <div class="callout">
              <strong>Open <em>LoginApp</em> to start work</strong> &mdash; it is the launcher. It signs you in, shows
              your assigned households/patients, and opens the right questionnaire for you. The other three are the
              questionnaires themselves; they must be installed, but you do not open them directly.
            </div>
            <div class="callout">
              <strong>Your assignment is already there &mdash; you do NOT need Bluetooth to get it.</strong>
              As of <strong>v1.1.2</strong>, signing in to LoginApp loads <em>your own</em> assigned households or
              patients straight from the app you just downloaded. There is nothing to receive from your STL before
              you can start. <em>(&ldquo;Receive Assignment&rdquo; over Bluetooth still works, and is still there if
              your assignment ever changes mid-round &mdash; but you do not need it to begin.)</em>
            </div>
            <div class="callout">
          ...
          <section>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr><td><em>Office-based</em></td><td>&mdash; no interviews that day</td></tr>
              </tbody>
            </table>
            <div class="callout callout-warn">
              <strong>If you are on HCW, you need a second, different login.</strong> F2 is a
              <strong>separate system from CSWeb</strong> &mdash; it runs in the browser at
              <code>uhc-hcw.asiansocial.org</code>, and <strong>your CSEntry / CSWeb login will not work there</strong>.
              Check that you can actually sign in to F2 <strong>the night before</strong>, not at the facility. If you
              do not have an F2 login, ask your STL now.
            </div>
            <table>
              <thead>
          ...
          <section>
            ...
            <h3>Why each facility has ten patient codes</h3>
            <p>
              Each facility above lists <strong>ten</strong> patient numbers, but the target is only five or so. The
              extras are <strong>not spare capacity to fill</strong> &mdash; they are there for the same reason as the
              household reserve: <strong>a patient who refuses is replaced, and the replacement is a new interview that
              needs a new number.</strong>
            </p>
            <div class="callout">
              So at a facility: work down your assigned numbers in order. If a patient refuses, is not found, or is
              ineligible, <strong>mark it on the Interview status screen</strong> (the case still counts &mdash; it is
              recorded as <em>Replaced</em>), then take the <strong>next unused number</strong> from that facility&rsquo;s
              range for the substitute patient. <strong>Do not stop at the target and go home if you have had
              refusals</strong> &mdash; the target is <em>completed interviews</em>, not doors knocked.
            </div>
          </section>
