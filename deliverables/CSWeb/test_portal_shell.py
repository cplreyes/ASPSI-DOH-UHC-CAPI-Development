...
# Portal URL since Slice 5 — the nginx proxy and this href flipped together.
check("admin needs admin.system", PS.NAV_PERMS.get(PS.P + "/admin/"), "admin.system")
...
# Active entry matches the admin nav href; both flipped together in Slice 5.
...
contains("partial ships the dim script", _php, "CAPI_SHELL_PERMDIM_JS")
contains("partial takes head extras", _php, "string $headExtra = ''")
