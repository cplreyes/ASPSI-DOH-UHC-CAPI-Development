<!--
CAPI Manual — Section I. Introduction
Overview/front matter (narrative + tables; not the per-procedure block). Grounded in our system + the 4-manual set. Screenshots N/A.
-->
