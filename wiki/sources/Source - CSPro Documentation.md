...
Web clipping of the [official CSPro documentation index](https://www.census.gov/data/software/cspro/documentation.html) maintained by the [[wiki/entities/US Census Bureau|US Census Bureau]] (page last revised 2024-01-30). This is a navigation page — it links to the canonical PDFs but does not contain their content.
...
- The desktop help system is the primary reference for designing census/survey applications, including those targeting CSEntry Android (see [[wiki/concepts/CSPro|CSPro]] for the Android/CAPI role in this project).
...
CSPro 8.0 is the chosen platform for the [[wiki/concepts/UHC Survey Year 2|UHC Survey Year 2]] CAPI build (see [[wiki/concepts/CSPro|CSPro]] concept page for the rationale vs SurveyCTO). This source pins the canonical references Carl will rely on for:
...
3. **CSWeb sync** — Data Transfer Guide governs how completed interviews move from enumerator tablets to the server (relevant to [[wiki/concepts/CSWeb|CSWeb]] deployment).
