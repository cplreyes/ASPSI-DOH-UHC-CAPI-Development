...
Health policy specialist on the [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/entities/ASPSI|ASPSI]] UHC Survey Year 2 team. Email: `mcsilva@up.edu.ph`. Known internally as **"Doc Myra"**.

## Role

- **Detailed question-level review** of the survey instruments (e.g., Row 53 facility tool clarification during the Tranche 1 review cycle).
- **Convened the Apr 13 LSS meeting** — on Apr 10 (08:45) proposed a short "lessons learned session" + tasking discussion for Tranche 2 following the v5 Tranche 1 resubmission; meeting scheduled for Mon Apr 13, 3:00 PM.
...
- "Doc Myra" in email threads = Dr. Ma. Esmeralda Silva-Javier. First clarified in [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/analyses/Analysis - Project Intelligence Brief|Analysis - Project Intelligence Brief]].

## Sources

- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/analyses/Analysis - Project Intelligence Brief]]
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - CAPI Translations PSA Deadline (Myra 2026-05-13)]]
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - HCW CAPI Comments Matrix (Myra answers 2026-05-21)]]
