...
ASPSI Research Assistant formally introduced at the [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - ASPSI Team Meeting 2026-04-13|Apr 13, 2026 ASPSI team meeting]] and assigned as **QA Tester** for the CSPro CAPI application and the [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/concepts/F2 Google Forms Track|F2 Google Forms track]]. Carl's primary tester and the first external pair of eyes on every build artifact.
...
- Engaged during Sprint 001 (Apr 2026) as the test pipeline for F2 and, downstream, F1/F3/F4 CSPro builds.
