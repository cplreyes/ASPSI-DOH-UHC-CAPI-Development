...
The second round of the Universal Health Care (UHC) Survey, commissioned by [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/entities/DOH-PMSMD|DOH-PMSMD]] to assess the implementation of RA 11223 (UHC Act). Conducted by [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/entities/ASPSI|ASPSI]] from November 2025 to August 2026.
...
2. **Healthcare Worker (F2)** — UHC awareness, HCPNs, satisfaction, compensation, PhilHealth benefits impact. Self-administered via the HCW Survey **PWA** (production v2.1.0, 7 languages), managed through the [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/concepts/F2 Admin Portal|F2 Admin Portal]]; not a CSPro instrument. The earlier [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/concepts/F2 Google Forms Track|F2 Google Forms Track]] was retired 2026-04-17. See [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Annex F2 Healthcare Worker Survey Questionnaire]].
...
- (Source: [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Signed CSA Dec 15 2025]]) — contractual frame for Carl's Data Programmer engagement on this survey
