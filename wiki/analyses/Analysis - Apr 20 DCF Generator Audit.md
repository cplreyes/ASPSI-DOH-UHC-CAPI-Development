...
> [!warning] Superseded — Apr-20 snapshot. The F2 **Google Forms** track described in this section was **retired 2026-04-17**; F2 shipped as the **HCW Survey PWA** (`deliverables/F2/PWA/app/`, prod v2.1.0, 7 languages) with the [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/concepts/F2 Admin Portal|Admin Portal]]. The DCF-generator analysis for F1/F3/F4 above remains valid.
