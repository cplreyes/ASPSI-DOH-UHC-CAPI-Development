# F2 PWA — Pretest Pilot Dry-Run · R4 (Admin Portal side) — Tester Guide
...
**Companion guide:** `docs/F2-PWA-Pretest-Dry-Run-R4-HCW-Survey-Tester-Guide-2026-06.md` (HCW Survey side — all four testers walk both)
...
5. Create the tracking issue `[E6-PWA-NNN] Pretest Pilot Dry-Run (R4)` + label **`from-pretest-dryrun-2026-06`**; drop the # into Section 1.
...
| **Bug-filing label** | `from-pretest-dryrun-2026-06` |
...
Apply `from-pretest-dryrun-2026-06` + link to the tracking issue on every R4 finding.

---

## 7. Triage Cadence

- **Daily check-in:** Coordinator posts to `#f2-pwa-uat` daily 09:00 PHT — new R4 findings (HCW + Admin), criticals, overnight fixes.
...
- **R4 close:** Friday 2026-06-12 PM. Coordinator reconciles the tracking issue; opens dispositioned (fix-now / next-sprint / route / won't-fix-with-rationale).
