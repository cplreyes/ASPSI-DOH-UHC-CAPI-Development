...
| **F3** Patient | **v6.1.1** | 2026-08-27 | [`F3/`](F3/README.md) | `00-deploy-result-6.1.1.png`, `01-app-list-v6.1.1.png`, and from v6.1.0: `f3_q8_{hil,war}_tablet.png`, `f3_icf_{hil,war}_tablet.png`, `f3_q97{1,2}_{hil,war}.png`, `f3_q115{1,2}_war.png`, `f3_q66_hil.png` | [`F3/byte-verify-6.1.1.txt`](F3/byte-verify-6.1.1.txt) — **ALL PASS** (4 measured counts, `[Mahirap magparehistro]` 0×) + [`F3/dcf-removal-proof-6.1.1.txt`](F3/dcf-removal-proof-6.1.1.txt) — per-code proof for the 28 removed rows, and no duplicate option label in 213 value sets × 8 languages |
...
**F4 v3.2.3** and **F3 v6.1.1**, each with its own `dcf-removal-proof-*.txt` beside its
byte-verify. Rows with no distinct translation on the paper are **deleted** from the map so the
English option renders — an English label beats one that repeats another option's words — and
every deleted row is on the translator worklist.
...
* Patch notes: `deliverables/CSPro/patch-notes/2026-08-27-f1-v4.1.1-aug21-translations.md`,
  `…/2026-08-26-f2-m4-aug21-translations.md`, `…/2026-08-27-f4-v3.2.3-aug21-translations.md`,
  `…/2026-08-27-f3-v6.1.1-aug21-translations.md`
