...
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - DOH UHC Year 2 Survey Manual]] — **Apr 28 2026 ver.** ASPSI-authored field manual (~95 pp): background, definitions, SOP (facility selection, courtesy calls, patient listing), data-collection protocol (F1/F2/F3/F4 by instrument), field reminders, quality control, duties of STLs/SEs, data processing. CSPro install section still SPEED 2023 legacy — Carl drafted replacement at `deliverables/Survey-Manual/CSPro-Section-Draft_2026-04-29.md`. Superseded by [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Working File (2026-05-06 Kidd)|the May 6 Working File]] which integrates Carl's CAPI inputs.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - DOH Survey Protocol V2 (30 April)]] — **SJREB + PSA submission baseline.** Master research protocol circulated by Myra 2026-04-30 with directive *"Please adjust the survey manual to the protocol."* ~6,092 lines: sampling design (F4 = 2,672 households w/ design effect 2.5 + urbanicity stratification per PIDS 2025; F3 outpatient 45/inpatient 30 per province w/ DE 1.0 + 50% oversampling; F2 with 60% master-list response gate + 40% midpoint trigger; F1 = 1,521 facilities + 5–10% replacement cap), eligibility per instrument, CSPro/CAPI prescription (F1/F3/F4 tablet CAPI + F2 online/offline PWA-compatible architecture), patient listing operational rules (CSPro-generated random intervals), CSWeb daily 10 PM upload mandate, version-numbered CAPI for traceability. Multiple "Annex XX" placeholders + open TODOs (DOH facility registry citation, F4 barangay listing method, encryption standard).
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Protocol vs Survey Manual Diff (Apr 30 Myra)]] — Claude-generated comparison Myra circulated 2026-04-30 alongside Protocol V2. Maps RS (Survey Manual) vs SP (Protocol) across all four modules: F1 has SP-only details (6-mo tenure, 5–10% replacement cap, private hospital extra eligibility); F2 differs on response threshold (RS 1-week follow-up vs SP 60% master list + BHW exclusion + single-reminder rule); F3 differs on residency requirement (RS = same-province ≥6 mo vs SP = no residency); F4 has SP-only urbanicity stratification + listing TODO. Useful operational checklist for the manual-to-protocol alignment.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - ASPSI Team Meeting 2026-05-04]] — Internal ASPSI meeting (Mon May 4): SJREB regions selected (NCR / Region 8 / Region IV-B); pre-test sites Los Baños + Bay (LPH-Bay District); 7-dialect translation list confirmed; **CAPI completion target June 12** (Carl + Shan); training Aug 1st-week supervisors + Aug 2nd–4th weeks teams; tablet procurement spec implied. Carl's lane intersects only at "share CAPI instructions for the manual" + "tablet specs to Juvy."
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Weekly Update Draft (2026-05-04 Kidd)]] — Short ASPSI→DOH weekly update from the May 4 meeting. Three follow-ups: technical clearance of IR + CHD endorsement letter (SJREB) + pre-testing endorsement letters. The message Kidd actually sent to DOH-PMSMD on Mon May 4 9:14 PM.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Working File (2026-05-06 Kidd)]] — **The live ASPSI Survey Manual** as of 2026-05-06, shared by Kidd via Google Doc. Kidd's update of the Apr 28 manual integrating Carl's 3-doc CAPI inputs + aligning to Protocol V2. ~2,222 lines. CSEntry install section verbatim from Carl. **Three integration gaps** flagged: HCW self-admin guide missing, bench-testing missing, three-point sync simplified to one daily. **Patient listing methodology divergence**: Working File reverts to Apr 28 per-patient-random-interval procedure; does not adopt Carl's continuous-listing-then-systematic refinement. **Questionnaire numbering variant**: Working File body splits last 5 digits as `-CC-CCC` (respondent type 2 + sequence-per-type 2) using doubled-digit codes 11/22/33/44; differs from Carl's brief + Appendix D's `-FF-CCC` partition.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix A — RA Contacts]] — Cluster table (matches Working File §3.1) + per-cluster placeholder contact blocks ("Juan dela Cruz" filler; numbers + emails blank). Template only. Cluster 5 entry duplicated (typo).
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix B — Sample Distribution]] — Three province/HUC-level distribution tables: F1 (1,521 sampled / 4,028 total; max per-province 53 Bulacan / max HUC 38 QC), F2 (~298 private hospital sample), F3 (5,400 outpatient + 3,600 inpatient cases at uniform 45+30 per facility). **Verifies the 12-digit case-ID widths**: FF=2 sufficient (max 53 < 99), CCC=3 highly sufficient (max per-facility per-instrument is 45 << 999).
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix C — Endorsement Letters]] — Image-only docx (signed letter scans); pandoc extraction returned empty body. Per Protocol V2 + the May 4 meeting, expected to contain DOH national endorsement + pre-testing endorsement letters. Out of Carl's lane.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix D — Case ID Format + Facility Master]] — Contains (1) the 12-digit case-ID format spec anchored on PSA 1Q 2026 PSGC + (2) facility master list with PSGC codes ↔ facility name ↔ count per LGU. Renamed 2026-05-08 (lint pass) — upstream `.docx` titled "Field Codes" is misleading; **no actual field codes** present (AAPOR / refusal / replacement reason / role / ownership / accreditation codes are all absent). Naming collision worth noting: this "Appendix D" ≠ existing wiki source `Source - Annex D Replacement Protocol` (Inception Report annex on replacement procedure).
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix E — UHC IS and non-IS]] — Geographic listing of the 120 sites (107 UHC IS + 13 non-UHC IS) by region. **Too thin for F1 facility master list** — no facility codes, PSGC codes, ownership, type, or coordinates. Use Appendix D's facility master instead.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - Survey Manual Appendix F — Patient Listing Form]] — Minimal paper template: 5 metadata fields + 25-row table with only Contact Number + Family Name (Optional). **Significantly drifted from F3b protocol** — no randomization metadata, no eligibility flags, no survey-tag (exit vs follow-up household), no listing_id. Paper backup, not the full spec.
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/sources/Source - UAT Round 2 Tester Feedback (2026-05) - HCW Survey + Admin Portal]] — **Shan's R2 tester feedback** (2 .docx files, ingested 2026-05-09): 14 HCW Survey observations + ~30 Admin Portal observations across 16 sub-areas. Cross-references all 27 GH placeholder issues (#68–#122). 22 are `status:fixed-pending-verify` via PR #113 (sessionStorage auth + deep-link + map clamp); 3 stale-blocked labels need correction (#97 #104 #105); 2 still-blocked on E4-APRT-041 (Encode/HCWs Create). Identifies dominant theme: session-refresh persistence; copy-string drift; data loss in Sections G/J.
...
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/entities/Shan Lait|Shan]] — CSPro CAPI app QA Tester (downstream); F2 PWA UAT Rounds 1+2 closed at v1.1.1, **Round 2 reopened against v2.0.0** (in flight with Kidd since 2026-05-04), **Round 3 against staging at v2.0.1-rc opens 2026-05-12**. Surfaced E4-APRT-050 orphan-admin guard finding 2026-05-07 R2 §5.12 U.E1.
...
- [[1_Projects/ASPSI-DOH-CAPI-CSPro-Development/wiki/concepts/F2 Admin Portal]] — Operations console (admin-only routes in F2 PWA): Users/Roles CRUD with versioning, force-revoke sessions, HCW token reissue with CAS, Apps dashboard shell. **Sprints AP1–AP4 complete; PR #54 merged 2026-05-04; v2.0.0 live in prod; UAT Round 2 open with Shan + Kidd.** **Sprint 005 v2.0.1 hotfix queue (10 items, ~14h committed)** — Tier 1 (security + lockout): **E4-APRT-050** orphan-admin guard *(surfaced 2026-05-07 R2 incident)*, **E4-APRT-051** change-password UI *(surfaced 2026-05-07)*, E4-APRT-045 password_must_change server-enforce, E4-APRT-044 RBAC cache eviction, **E4-APRT-043 prod ADMIN_PASSWORD_HASH delete**. Tier 2 (visible UX gaps): E4-APRT-048 last_login_at write, E4-APRT-041 Create-HCW UI, E4-APRT-042 per-tester admin accounts. Tier 3 (deferrable polish): E4-APRT-037 concurrency tests, E4-APRT-049 design-review sweep umbrella (#59–62, #67). E4-APRT-046/047 (Files Create-Folder + Rename, CSWeb-mirror parity) remain unscheduled pending PO scheduling. Sprint 005 plan doc at `docs/superpowers/plans/2026-05-11-sprint-005-v2-0-1-plan.md`; UAT Round 3 against staging opens 2026-05-12.
